...
| **Inspiration** | What you **cultivate** | Fuels artist productivity. A city-wide pool generated by plazas, decorations, and displayed masterworks. Workshops near a plaza get a flat efficiency bonus (soft spatial — no hard radius). |
...
- **Soft spatial:** workshops within a few tiles of a plaza get a flat efficiency bonus. No hard radius, no in/out cliff — proximity is a nudge, not a requirement.
...
6. **Soft spatial meaning.** Proximity to a plaza is a nudge (flat bonus), never a hard cliff. Players are never punished for building something that looks good to them.
